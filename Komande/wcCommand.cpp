...
void WcCommand::execute(std::string &opt, std::string &argument, std::ostream &output, bool &redirectExist, std::string &lastResult, bool &pipeExist, bool &isFirst, bool &isLast) {
    ...
    if (opt == "-w") processOptW(text, output, redirectExist, redirectFile, doubleRedirect, lastResult, pipeExist, isFirst, isLast);
    else if (opt == "-c") processOptC(text, output, redirectExist, redirectFile, doubleRedirect, lastResult, pipeExist, isFirst, isLast);
}

void WcCommand::processOptW(std::string& text, std::ostream& output, bool &redirectExist, std::string &redirectFile, bool &doubleRedirect, std::string &lastResult, bool &pipeExist, bool &isFirst, bool &isLast) {
    size_t i = 0;
...
void WcCommand::processOptC(std::string& text, std::ostream& output, bool &redirectExist, std::string &redirectFile, bool &doubleRedirect, std::string &lastResult, bool &pipeExist, bool &isFirst, bool &isLast) {
    size_t i = 0;
